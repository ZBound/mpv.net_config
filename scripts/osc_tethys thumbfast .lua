...
local plPrevTooltip = ("上一集 %s"):format(formatBinds(plPrevBinds))
local plNextTooltip = ("下一集 %s"):format(formatBinds(plNextBinds))
local chPrevTooltip = ("上一章节 %s"):format(formatBinds(chPrevBinds))
local chNextTooltip = ("下一章节 %s"):format(formatBinds(chNextBinds))
local audioTooltip = ("声轨 %s"):format(formatBinds(audioBinds))
local subTooltip = ("字幕 %s"):format(formatBinds(subBinds))
...
local fullscreenTooltip = ("全屏 %s"):format(formatBinds(fullscreenBinds))
